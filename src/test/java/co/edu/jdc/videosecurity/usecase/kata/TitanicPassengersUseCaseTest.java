...
public class TitanicPassengersUseCaseTest {
    ...
    void givenValidFileIfSurvived() {
        Integer result = titanicPassengersUseCase.quantityOfParameter(ParameterEnum.SURVIVED, 1);
        Assertions.assertEquals(result, 10);
    }

    @Test
    void givenValidFileElseSurvived() {
        Integer result = titanicPassengersUseCase.quantityOfParameter(ParameterEnum.SURVIVED, 0);
        Assertions.assertEquals(result, 10);
    }

    @Test
    void givenValidFileIfSurvivedFalse() {
        Integer result = titanicPassengersUseCase.quantityOfParameter(ParameterEnum.SURVIVED, 3);
    ...
    void givenValidFileClassOne() {
        Integer result = titanicPassengersUseCase.quantityOfParameter(ParameterEnum.PCLASS, 1);
        Assertions.assertEquals(result, 4);
    }

    @Test
    void givenValidFileClassTwo() {
        Integer result = titanicPassengersUseCase.quantityOfParameter(ParameterEnum.PCLASS, 2);
    ...
    void givenValidFileClassThree() {
        Integer result = titanicPassengersUseCase.quantityOfParameter(ParameterEnum.PCLASS, 3);
        Assertions.assertEquals(result, 13);
    }

    @Test
    void givenValidFileClassThreeFalse() {
        Integer result = titanicPassengersUseCase.quantityOfParameter(ParameterEnum.PCLASS, 4);
        Assertions.assertEquals(result, 0);
    }

    @Test
    void givenValidFileSexMale() {
        Integer result = titanicPassengersUseCase.quantityOfParameter(ParameterEnum.SEX, "male");
        Assertions.assertEquals(result, 9);
    }
    @Test
    void givenValidFileSexFemale(){
        Integer result = titanicPassengersUseCase.quantityOfParameter(ParameterEnum.SEX, "female");
        Assertions.assertEquals(result, 11);
    }
    @Test
    void givenValidFileSexFemaleFalse(){
        Integer result = titanicPassengersUseCase.quantityOfParameter(ParameterEnum.SEX, "ma");
        Assertions.assertEquals (result, 0);
    }

    @Test
    void givenValidFileAge(){
        Integer result = titanicPassengersUseCase.quantityOfParameter(AGE, 22);
    ...
    void givenValidFileAgeFalse(){
        Integer result = titanicPassengersUseCase.quantityOfParameter(AGE, 100);
        Assertions.assertEquals(result, 0);
    }
